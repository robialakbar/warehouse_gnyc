                    ...
                    <div id="form" class="card">
                        <div class="card-body">
                            <form role="form" id="save" action="{{ route('products.wip.save') }}" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-4 col-form-label">{{ __('Customer') }}</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    <label for="wip_date" class="col-sm-4 col-form-label">Date</label>
                                    <div class="col-sm-8">
